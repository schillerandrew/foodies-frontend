          ...
          <Card.Body>
            ...
            <div className="btncontainer">
              <Button className="selfiebutton" type="button" class="btn btn-secondary"> <a href='https://www.linkedin.com/in/schillerandrew/' style={{textDecoration: 'none'}}>
                <i class="devicon-linkedin-plain"></i> LinkedIn</a></Button>
              <Button className="selfiebutton" type="button" class="btn btn-secondary"> <a href='https://github.com/schillerandrew' style={{textDecoration: 'none'}}><i class="devicon-github-original colored"></i> GitHub</a></Button>
            </div>
          </Card.Body>
        </Card>
        <Card style={{ width: '30rem' }}>
          <Card.Body>
            ...
            <div className="btncontainer">
              <Button className="selfiebutton" type="button" class="btn btn-secondary"> <a href='https://www.linkedin.com/in/rogermreyes/' style={{textDecoration: 'none'}}>
                <i class="devicon-linkedin-plain"></i> LinkedIn</a></Button>
              <Button className="selfiebutton" type="button" class="btn btn-secondary"> <a href='https://github.com/RogerMReyes' style={{textDecoration: 'none'}}><i class="devicon-github-original colored"></i> GitHub</a></Button>
            </div>
          </Card.Body>
        </Card>
        <Card style={{ width: '30rem' }}>
          <Card.Body>
            ...
            <div className="btncontainer">
              <Button className="selfiebutton" type="button" class="btn btn-secondary"> <a href='https://www.linkedin.com/in/michael-brunette-0800b5233/' style={{textDecoration: 'none'}}>
                <i class="devicon-linkedin-plain"></i> LinkedIn</a></Button>
              <Button className="selfiebutton" type="button" class="btn btn-secondary"> <a href='https://github.com/mcbrunette33' style={{textDecoration: 'none'}}><i class="devicon-github-original colored"></i> GitHub</a></Button>
            </div>
          </Card.Body>
        </Card>
      </div>
