    ...
    <div className="profiles" >
      <Card style={{ width: '30rem' }}>
        <Card.Body>
          ...
          <Button className="selfiebutton" type="button" class="btn btn-secondary"> <a href= 'https://www.linkedin.com/in/schiller-andrew/'> LinkedIn</a></Button>
          <Button className="selfiebutton" type="button" class="btn btn-secondary"> <a href= 'https://github.com/schillerandrew'> GitHub</a></Button>
          </div>
        </Card.Body>
      </Card>
      <Card style={{ width: '30rem' }}>
      <Card.Body>
        ...
        <div className="btncontainer">
        <Button className="selfiebutton" type="button" class="btn btn-secondary"> <a href= 'https://www.linkedin.com/in/rogermreyes/'> LinkedIn</a></Button>
        <Button className="selfiebutton" type="button" class="btn btn-secondary"> <a href= 'https://github.com/RogerMReyes'> GitHub</a></Button>
        </div>
      </Card.Body>
    </Card>
    <Card style={{ width: '30rem' }}>
      <Card.Body>
        ...
        <div className="btncontainer">
        <Button className="selfiebutton" type="button" class="btn btn-secondary"> <a href= 'https://www.linkedin.com/in/michael-brunette-0800b5233/'> LinkedIn</a></Button>
        <Button className="selfiebutton" type="button" class="btn btn-secondary"> <a href= 'https://github.com/mcbrunette33'> GitHub</a></Button>
        </div>
      </Card.Body>
    </Card>
    </div>
